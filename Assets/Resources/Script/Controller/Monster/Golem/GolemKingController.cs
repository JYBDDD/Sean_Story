...
public class GolemKingController : MonsterBaseController
{
    ...
    private void OnEnable()
    {
        ...
        _stat = JsonConvert.DeserializeObject<StatData>(GameManager.Resource.Load<TextAsset>("Data/Monster/GolemKingStatData").text).Mstat;
    ...
    protected override void StateIdle()
    {
        ...
        if ((_destVec - transform.position).magnitude < 2f)
        {
