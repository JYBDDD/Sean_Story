...
public class GruntController : MonsterBaseController
{
    ...
    {
        _stat = JsonConvert.DeserializeObject<StatData>(GameManager.Resource.Load<TextAsset>("Data/Monster/GruntStatData").text).Mstat;
